...
function sendEnrollmentAcceptedEmail($RecipientEmail, $RecipientName, $EnrollmentTitle)
{
    $mail = new PHPMailer(true);
    try {
        // Server settings
        ...
        // Recipients
        $mail->setFrom('noreply@youdemy.com', 'Youdemy Support'); // Use a proper support email
        $mail->addAddress($RecipientEmail, $RecipientName);

        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Youdemy: Enrollment Accepted';
        $mail->Body = "<p>Dear $RecipientName,</p>
                       <p>Congratulations! Your enrollment in <strong>$EnrollmentTitle</strong> has been accepted. You can now access the course and start your learning journey.</p>
                       <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                       <p>Best regards,<br>Youdemy Team</p>";
